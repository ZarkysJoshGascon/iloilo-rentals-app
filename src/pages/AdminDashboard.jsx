...
import AdminAccounting from '../components/AdminAccounting'          // NEW import
...
export default function AdminDashboard() {
  ...
  // Updated tab mappings – 'owners' becomes 'accounting'
  const tabIcons = {
  ...
  const sidebarLeftOffset = 12               // 3mm from left
  const sidebarCollapsedWidth = 56           // w-14  (px)
  const sidebarExpandedWidth = 224           // w-56
  const pageOverlap = 4                       // how much the page covers the sidebar
  ...
  // Sidebar style – spans from left offset to the right edge of the screen
  const sidebarStyle = {
  ...
  return (
    <div className="h-screen flex flex-col bg-[#d4deec] dark:bg-gray-900 overflow-hidden transition-colors duration-300">
      ...
      <div className="flex-1 relative min-h-0">
        {/* Sidebar – spans full width behind page */}
        ...
        {/* Content – slides right when sidebar expands */}
        <div
