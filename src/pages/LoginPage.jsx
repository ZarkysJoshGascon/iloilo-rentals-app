...
export default function LoginPage() {
  ...
  // Detect if user is in an embedded browser (Messenger, Facebook, Instagram, etc.)
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#2d568e]/5 via-white to-[#2d568e]/10 overflow-hidden">
      ...
      >
        ...
        {/* Warning for embedded browsers - ONLY appears in Messenger/Facebook/Instagram */}
        {isInAppBrowser && (
          <motion.div 
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-sm font-semibold text-amber-800">Cannot sign in here</p>
            ...
            <p className="text-xs text-amber-600 text-center mt-3">
              This will open the page in your default browser where sign-in works
            </p>
          </motion.div>
        )}
        ...
        <motion.button
          ...
          initial="hidden"
          animate="visible"
          whileHover={!isInAppBrowser ? "hover" : {}}
          whileTap={!isInAppBrowser ? "tap" : {}}
        ...
        >
          <motion.span 
            ...
            initial={{ x: "-100%" }}
            whileHover={!isInAppBrowser ? { x: "100%" } : {}}
